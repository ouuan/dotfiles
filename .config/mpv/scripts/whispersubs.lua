...
local WHISPER_CMD = "whisper-cli -m ~/data/ggml-large-v3-q5_0.bin --language ja --no-prints"

-- Additional variables
local CHUNK_SIZE = 20 * 1000 		 -- the amount of subs to process at a time in ms
